...
public class TestConstants {
    ...
    public static class IntegrationTest {
        public static final String APPLICATION_SHORT_NAME = "hello";
        public static final String APPLICATION_NAME = "hello-application";
        public static final String APPLICATION_VERSION = "v0.0.1";
        public static final String APPLICATION_DESCRIPTION = "Hello World Application";

        public static final String SERVICE_SHORT_NAME = "hello-integration-test";
        public static final String SERVICE_NAME = "UST-MICO/hello";
        public static final String SERVICE_DESCRIPTION = "Hello World Service for integration testing";

        public static final String SERVICE_INTERFACE_NAME = "hello-interface";
         ...
         */
        public static final String GIT_CLONE_URL = "https://github.com/UST-MICO/hello.git";
         ...
         */
        public static final String DOCKER_IMAGE_URI = "ustmico/" + SERVICE_SHORT_NAME + ":" + RELEASE;

...
public class KafkaFaasConnectorDeploymentInfoResourceEndToEndTests extends Neo4jTestClass {
    ...
    private static final String DEPLOYMENT_INFO_RESPONSE_DTO_LIST_JSON_PATH = JsonPathBuilder.buildPath(ROOT, EMBEDDED, "micoServiceDeploymentInfoResponseDTOList");

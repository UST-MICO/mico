...
public class MicoApplicationIsNotUndeployedException extends Exception {
    ...
    public MicoApplicationIsNotUndeployedException(String shortName) {
        super("Application '" + shortName + "' is currently not undeployed!");
    }

    public MicoApplicationIsNotUndeployedException(Long id) {
        super("Application '" + id + "' is currently not undeployed!");
    }
